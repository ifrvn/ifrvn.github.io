...
export default hopeTheme({
  ...
  blog: {
    ...
    medias: {
      ...
      Weibo: "https://weibo.com/u/7080285524",
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "Nothing you need to know about me",
        intro: "/intro.html",
      },
